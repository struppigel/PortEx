...
package io.github.struppigel.parser.sections.pdata

import io.github.struppigel.parser.IOUtil.{NL, SpecificationFormat}
import io.github.struppigel.parser.coffheader.MachineType._
...
import io.github.struppigel.parser.{FileFormatException, IOUtil, PELoader, StandardField}
