...
import io.github.struppigel.parser.optheader.{DataDirectoryKey, OptionalHeader, StandardFieldEntryKey, Subsystem, WindowsEntryKey}
import io.github.struppigel.parser.sections.{SectionCharacteristic, SectionLoader}
