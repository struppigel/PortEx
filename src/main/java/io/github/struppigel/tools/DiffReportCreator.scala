...
import io.github.struppigel.parser.coffheader.{COFFFileHeader, COFFHeaderKey}
import io.github.struppigel.parser.{ByteArrayUtil, PEData, PELoader, StandardField}
import io.github.struppigel.parser.msdos.{MSDOSHeader, MSDOSHeaderKey}
import io.github.struppigel.parser.optheader.{DataDirEntry, OptionalHeader, OptionalHeaderKey}
import io.github.struppigel.parser.sections.{SectionCharacteristic, SectionHeader, SectionHeaderKey, SectionTable}
