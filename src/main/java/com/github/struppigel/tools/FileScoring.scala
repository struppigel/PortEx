...
import com.github.struppigel.parser.{FileFormatException, IOUtil, PELoader, PESignature}
import com.github.struppigel.tools.anomalies.{Anomaly, AnomalySubType, PEAnomalyScanner}
...
object FileScoring {
  ...
  private val title = """MalDet v0.3
                    ...
                    |MalDet is made with PortEx: https://github.com/struppigel/PortEx
                    |""".stripMargin
