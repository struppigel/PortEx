...
import com.github.struppigel.parser.ScalaIOUtil.{bytes2hex, using}
import com.github.struppigel.parser.optheader.StandardFieldEntryKey._
import SignatureScanner._
import com.github.struppigel.parser.sections.SectionLoader
import com.github.struppigel.parser.{FileFormatException, IOUtil, PELoader, ScalaIOUtil}
