...
package com.github.struppigel.parser.sections.rsrc.icon

import com.github.struppigel.parser.IOUtil._
import com.github.struppigel.parser.ScalaIOUtil.{hex, using}
import GroupIconResource.NID
import com.github.struppigel.parser.{ByteArrayUtil, PhysicalLocation}
import com.github.struppigel.parser.sections.rsrc.{ID, Level, Resource}
