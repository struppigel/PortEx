...
import MetadataRoot.{alignToFourBytes, versionOffset}
import MetadataRootKey._
import com.github.struppigel.parser.IOUtil.SpecificationFormat
import com.github.struppigel.parser.sections.SectionLoader
import com.github.struppigel.parser.{FileFormatException, IOUtil, MemoryMappedPE, PEData, PhysicalLocation, ScalaIOUtil, StandardField}
