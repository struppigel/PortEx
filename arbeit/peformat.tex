...
\begin{definition}[invalid field]
...
\begin{definition}[structural malformation]
...
\end{definition} \todo{redefine}

Structural malformations include:
...
\item loops in, \eg{}, the Resource Section tree, or import and export entries calling each other \todo{better name?}
\item dummy entries, \eg{} to obfuscate imports
\end{itemize}

\todo{sort in the malformations to the correct subsections}
